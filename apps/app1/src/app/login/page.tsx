...
export default function AutenticacaoPage() {
  ...
  const handleLoginError = () => {
    setMensagem(
      "Erro ao fazer login. Tente com email: teste@exemplo.com e senha: 123456",
    );
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Este formulário é importado do pacote compartilhado{" "}
            <strong style={{ color: "#2563eb" }}>@monorepo/shared-ui</strong> e
            pode ser utilizado em qualquer aplicativo do monorepo.
          </p>
